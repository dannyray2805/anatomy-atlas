  ...
  return (
    <div className="doc-page idx-page">
      ...
      <p className="idx-foot">
        Parts of the bodies are not mapped to structures yet — bone, muscle, most named blood
        vessels and peripheral nerves report “not mapped to a structure” when clicked. They are
