...
- Present in BOTH the male and female VH heart layers: `VH_M_heart_right_ventricle` (male, ref-organ heart v1.3) and `VH_F_right_ventricle` (female, ref-organ heart v1.3) — unlike `heart-left-ventricle`, which is currently mapped male-only (hubmap-hra-glb).
